...
// ---- Worldwide Student Areas ----
const List<Map<String, dynamic>> _kStudentAreas = [
  // ── Pakistan ──
  {'city': 'Lahore',       'area': 'DHA / Johar Town',        'country': 'Pakistan',   'flag': '🇵🇰', 'icon': Icons.location_city,   'color': 0xFF7A1F35},
  {'city': 'Islamabad',    'area': 'F-7 / F-8 / Blue Area',   'country': 'Pakistan',   'flag': '🇵🇰', 'icon': Icons.domain,          'color': 0xFF7A1F35},
  {'city': 'Karachi',      'area': 'DHA / Gulshan',            'country': 'Pakistan',   'flag': '🇵🇰', 'icon': Icons.apartment,       'color': 0xFF7A1F35},
  {'city': 'Peshawar',     'area': 'Hayatabad / University Rd','country': 'Pakistan',   'flag': '🇵🇰', 'icon': Icons.school,          'color': 0xFF7A1F35},
  {'city': 'Faisalabad',   'area': 'Peoples Colony / NFC',     'country': 'Pakistan',   'flag': '🇵🇰', 'icon': Icons.villa,           'color': 0xFF7A1F35},
  {'city': 'Rawalpindi',   'area': 'Saddar / Bahria Town',     'country': 'Pakistan',   'flag': '🇵🇰', 'icon': Icons.house,           'color': 0xFF7A1F35},
  // ── UK ──
  {'city': 'London',       'area': 'Stratford / Mile End',     'country': 'UK',         'flag': '🇬🇧', 'icon': Icons.location_city,   'color': 0xFF1A3A6B},
  {'city': 'Manchester',   'area': 'Fallowfield / Withington', 'country': 'UK',         'flag': '🇬🇧', 'icon': Icons.apartment,       'color': 0xFF1A3A6B},
  {'city': 'Birmingham',   'area': 'Selly Oak / Edgbaston',    'country': 'UK',         'flag': '🇬🇧', 'icon': Icons.school,          'color': 0xFF1A3A6B},
  {'city': 'Leeds',        'area': 'Hyde Park / Headingley',   'country': 'UK',         'flag': '🇬🇧', 'icon': Icons.domain,          'color': 0xFF1A3A6B},
  {'city': 'Edinburgh',    'area': 'Marchmont / Newington',    'country': 'UK',         'flag': '🇬🇧', 'icon': Icons.castle,          'color': 0xFF1A3A6B},
  // ── USA ──
  {'city': 'New York',     'area': 'Manhattan / Brooklyn',     'country': 'USA',        'flag': '🇺🇸', 'icon': Icons.location_city,   'color': 0xFF1B4332},
  {'city': 'Los Angeles',  'area': 'Westwood / Koreatown',     'country': 'USA',        'flag': '🇺🇸', 'icon': Icons.wb_sunny,        'color': 0xFF1B4332},
  {'city': 'Chicago',      'area': 'Hyde Park / Lincoln Park',  'country': 'USA',        'flag': '🇺🇸', 'icon': Icons.apartment,       'color': 0xFF1B4332},
  {'city': 'Houston',      'area': 'University District',       'country': 'USA',        'flag': '🇺🇸', 'icon': Icons.school,          'color': 0xFF1B4332},
  // ── Canada ──
  {'city': 'Toronto',      'area': 'Annex / Kensington',        'country': 'Canada',     'flag': '🇨🇦', 'icon': Icons.location_city,   'color': 0xFF7B2D00},
  {'city': 'Vancouver',    'area': 'UBC / Kitsilano',            'country': 'Canada',     'flag': '🇨🇦', 'icon': Icons.nature,          'color': 0xFF7B2D00},
  {'city': 'Montreal',     'area': 'Plateau / McGill Ghetto',   'country': 'Canada',     'flag': '🇨🇦', 'icon': Icons.apartment,       'color': 0xFF7B2D00},
  // ── Australia ──
  {'city': 'Melbourne',    'area': 'Carlton / Fitzroy',          'country': 'Australia',  'flag': '🇦🇺', 'icon': Icons.location_city,   'color': 0xFF0A3D62},
  {'city': 'Sydney',       'area': 'Ultimo / Newtown',           'country': 'Australia',  'flag': '🇦🇺', 'icon': Icons.beach_access,    'color': 0xFF0A3D62},
  {'city': 'Brisbane',     'area': 'West End / St Lucia',        'country': 'Australia',  'flag': '🇦🇺', 'icon': Icons.school,          'color': 0xFF0A3D62},
  // ── Middle East ──
  {'city': 'Dubai',        'area': 'Al Barsha / Deira',          'country': 'UAE',        'flag': '🇦🇪', 'icon': Icons.location_city,   'color': 0xFF5C3D11},
  {'city': 'Riyadh',       'area': 'Al Malqa / Olaya',           'country': 'Saudi Arabia','flag': '🇸🇦','icon': Icons.domain,          'color': 0xFF5C3D11},
  {'city': 'Doha',         'area': 'Education City',             'country': 'Qatar',      'flag': '🇶🇦', 'icon': Icons.school,          'color': 0xFF5C3D11},
  // ── Europe ──
  {'city': 'Berlin',       'area': 'Mitte / Prenzlauer Berg',    'country': 'Germany',    'flag': '🇩🇪', 'icon': Icons.location_city,   'color': 0xFF2C3E50},
  {'city': 'Paris',        'area': 'Latin Quarter / Montmartre', 'country': 'France',     'flag': '🇫🇷', 'icon': Icons.apartment,       'color': 0xFF2C3E50},
  {'city': 'Amsterdam',    'area': 'De Pijp / Jordaan',          'country': 'Netherlands','flag': '🇳🇱', 'icon': Icons.pedal_bike,      'color': 0xFF2C3E50},
  {'city': 'Barcelona',    'area': 'Gracia / Poblenou',           'country': 'Spain',      'flag': '🇪🇸', 'icon': Icons.beach_access,    'color': 0xFF2C3E50},
];
...
class _HomeScreenState extends State<HomeScreen> {
        ...
        child: RefreshIndicator(
          ...
          child: CustomScrollView(
            slivers: [
              ...
              SliverToBoxAdapter(
                child: _buildPopularStudentAreas(),
              ),
              // BANNER CAROUSEL
              SliverToBoxAdapter(
  ...
  Widget _buildLocationFilters() {
    final cities = [
      ...
      {'name': 'London',    'icon': Icons.location_on},
      {'name': 'Toronto',   'icon': Icons.park},
      {'name': 'Sydney',    'icon': Icons.beach_access},
    ];
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(city['icon'] as IconData, color: _kGold, size: 20),
  ...
  // ---- POPULAR STUDENT AREAS ----
  Widget _buildPopularStudentAreas() {
    // Group areas by country
    final Map<String, List<Map<String, dynamic>>> grouped = {};
    for (final area in _kStudentAreas) {
      final country = area['country'] as String;
      grouped.putIfAbsent(country, () => []).add(area);
    }
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemCount: _kStudentAreas.length,
            itemBuilder: (context, index) {
              final area = _kStudentAreas[index];
              final baseColor = Color(area['color'] as int);
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => SeeAllListingsScreen(
                        title: '${area['city']} Listings',
                        cityFilter: area['city'] as String,
                      ),
                    ),
                  );
                },
